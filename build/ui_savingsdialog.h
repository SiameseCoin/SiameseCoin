...
public:
    ...
    void retranslateUi(QWidget *AutoSavingsDialog)
    {
        ...
        label_2->setText(QApplication::translate("AutoSavingsDialog", "Auto Savings allows you to automatically send up to 50% of your stake to another BottleCaps address after it matures.\n"
"\n"
"Please enter percentage to give and BottleCaps address to save to. Min and Max amount are optional.", 0));
#ifndef QT_NO_TOOLTIP
