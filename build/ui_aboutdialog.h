...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BottleCaps", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BottleCaps</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2009-2014 The BottleCaps Foundation", 0));
